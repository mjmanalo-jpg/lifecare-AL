...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPERADMIN', 'FACILITY_ADMIN', 'CARE_MANAGER', 'RESIDENT_COORDINATOR', 'BILLING_ADMIN', 'PHYSICIAN', 'NURSE', 'CAREGIVER', 'FAMILY', 'RESIDENT', 'FLEET_MANAGEMENT', 'DRIVER', 'SECURITY', 'NUTRITIONIST', 'KITCHEN', 'HOUSEKEEPING', 'MAINTENANCE');
