...
const PORTAL_PATH_RE = /^\/(platform_admin|organization_admin|nurse|physician|caregiver|family|resident|superadmin|facility_admin|care_manager|resident_coordinator|billing_admin|fleet_management|driver|security|nutritionist|kitchen|housekeeping|maintenance)(\/|$)/i;
