        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {tab === "mobility" && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div><label className={labelCls}>Assistance Level</label><select value={form.assistanceLevel || ""} onChange={e => set("assistanceLevel", e.target.value)} className={inputCls}><option value="SBA">Standby Assistance (SBA)</option><option value="CGA">Contact Guard Assistance (CGA)</option><option value="MIN">Minimal Assistance (Min)</option><option value="MOD">Moderate Assistance (Mod)</option><option value="MAX">Maximum Assistance (Max)</option><option value="TOTAL">Total Assistance (T)</option></select></div>
