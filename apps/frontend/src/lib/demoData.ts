...
const staff = [
  { id: "s1", position: "Head Nurse", department: "Clinical Care", isActive: true, hireDate: iso(1200 * D), userId: "u2", user: { name: "Sarah Jenkins", email: "sarah.jenkins@lifecare.com", phone: "555-0101" } },
  { id: "s2", position: "RN - Supervisor", department: "Clinical Care", isActive: true, hireDate: iso(1800 * D), userId: "u3", user: { name: "Rebecca Wilson", email: "rebecca.wilson@lifecare.com", phone: "555-0105" } },
  { id: "s3", position: "Caregiver", department: "Daily Assistance", isActive: true, hireDate: iso(560 * D), userId: "u4", user: { name: "Caleb Randall", email: "caleb.randall@lifecare.com", phone: "555-0102" } },
  { id: "s4", position: "Caregiver", department: "Daily Assistance", isActive: true, hireDate: iso(300 * D), userId: "u5", user: { name: "James Mitchell", email: "james.mitchell@lifecare.com", phone: "555-0104" } },
  { id: "s5", position: "Nurse Aide", department: "Clinical Support", isActive: false, hireDate: iso(1500 * D), userId: "u6", user: { name: "Maria Santos", email: "maria.santos@lifecare.com", phone: "555-0103" } },
];
...
const blogPosts = [
  {
    id: "bp1",
    title: "Welcome to LifeCare Wellness Residence",
