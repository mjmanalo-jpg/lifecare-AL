...
export const ROLES: Record<Role, RoleDetails> = {
  ...
  NURSE: {
    ...
    sidebarLinks: [
      ...
      // Resident Care — Task Board first.
      { name: "Task Board", icon: ListTodo, route: "/nurse/taskassignment", group: "Resident Care" },
      ...
      { name: "Today's Care", icon: CalendarCheck, route: "/nurse/todayscare", group: "Resident Care" },
      // Resident Records
      { name: "Resident Directory", icon: UserRound, route: "/nurse/residents", group: "Resident Records" },
      { name: "One Care · One Journey", icon: Route, route: "/nurse/residentjourney", group: "Resident Records" },
      { name: "Clinical Records", icon: FolderOpen, route: "/nurse/clinicalrecords", group: "Resident Records" },
      { name: "Care Timeline", icon: History, route: "/nurse/carehistory", group: "Resident Records" },
      // KPI Reports
      { name: "Progress Reports", icon: FileText, route: "/nurse/progressreport", group: "KPI Reports" },
      { name: "Care Delivery", icon: Activity, route: "/nurse/caredelivery", group: "KPI Reports" },
      { name: "Vital Sign Trends", icon: HeartPulse, route: "/nurse/vitalstrend", group: "KPI Reports" },
      // Operations
      { name: "Pre-Admission Assessment (v4.2)", icon: ClipboardList, route: "/nurse/prescreen", group: "Operations" },
      // Medication
      ...
      { name: "Clinical Protocols", icon: ScrollText, route: "/nurse/clinicalprotocols", group: "Administration" },
      { name: "Emergency & Evacuation", icon: Siren, route: "/nurse/emergencyprotocol", group: "Administration" },
  ...
  CAREGIVER: {
    ...
    sidebarLinks: [
      ...
      { name: "Today's Care", icon: ClipboardCheck, route: "/caregiver/todayscare", group: "Resident Care" },
      ...
      // Resident Records
      { name: "Care Timeline", icon: History, route: "/caregiver/carehistory", group: "Resident Records" },
      // KPI Reports
      { name: "Vital Sign Trends", icon: HeartPulse, route: "/caregiver/vitalstrend", group: "KPI Reports" },
      // Medication
  ...
  CARE_MANAGER: {
    ...
    sidebarLinks: [
      ...
      // Resident Care — Task Board first.
      { name: "Task Board", icon: ListTodo, route: "/care_manager/taskassignment", group: "Resident Care" },
      ...
      { name: "Today's Care", icon: CalendarCheck, route: "/care_manager/todayscare", group: "Resident Care" },
      // Resident Records
      { name: "Resident Directory", icon: UserRound, route: "/care_manager/residents", group: "Resident Records" },
      { name: "One Care · One Journey", icon: Route, route: "/care_manager/residentjourney", group: "Resident Records" },
      { name: "Clinical Records", icon: FolderOpen, route: "/care_manager/clinicalrecords", group: "Resident Records" },
      { name: "Care Timeline", icon: History, route: "/care_manager/carehistory", group: "Resident Records" },
      // KPI Reports
      { name: "Progress Reports", icon: FileText, route: "/care_manager/progressreport", group: "KPI Reports" },
      { name: "Care Delivery", icon: Activity, route: "/care_manager/caredelivery", group: "KPI Reports" },
      { name: "Quality & Outcomes", icon: TrendingUp, route: "/care_manager/quality", group: "KPI Reports" },
      { name: "Vital Sign Trends", icon: HeartPulse, route: "/care_manager/vitalstrend", group: "KPI Reports" },
      // Operations
      { name: "Pre-Admission Assessment (v4.2)", icon: ClipboardList, route: "/care_manager/prescreen", group: "Operations" },
      // Medication
      ...
      { name: "Clinical Protocols", icon: ScrollText, route: "/care_manager/clinicalprotocols", group: "Administration" },
      { name: "Emergency & Evacuation", icon: Siren, route: "/care_manager/emergencyprotocol", group: "Administration" },
