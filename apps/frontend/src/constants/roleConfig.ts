...
export const ROLES: Record<Role, RoleDetails> = {
  ...
  NURSE: {
    ...
    sidebarLinks: [
      ...
      { name: "Task Assignment", icon: ClipboardList, route: "/nurse/taskassignment", group: "Administration" },
      { name: "Camera Activity Log", icon: Camera, route: "/nurse/cameralogs", group: "Clinical Monitoring" },
      { name: "Residents", icon: Users, route: "/nurse/residents", group: "Resident Care" },
      { name: "Care Logs", icon: ClipboardList, route: "/nurse/carelogs", group: "Resident Care" },
      { name: "Care History", icon: History, route: "/nurse/carehistory", group: "Resident Care" },
      { name: "Clinical Records", icon: FolderOpen, route: "/nurse/clinicalrecords", group: "Resident Care" },
      { name: "ADL Monitoring", icon: Activity, route: "/nurse/adlmonitoring", group: "Resident Care" },
      { name: "Weight Monitoring", icon: Scale, route: "/nurse/weightmonitoring", group: "Resident Care" },
      { name: "Vitals Trend", icon: Activity, route: "/nurse/vitalstrend", group: "Resident Care" },
      { name: "Shift Summary", icon: ClipboardCheck, route: "/nurse/shiftsummary", group: "Resident Care" },
      { name: "Shift Endorsements", icon: FileText, route: "/nurse/shiftendorsements", group: "Coordination & Comms" },
      { name: "Care Acuity & Level of Care", icon: Gauge, route: "/nurse/careacuity", group: "Resident Care" },
      { name: "Wound Care", icon: Activity, route: "/nurse/woundcare", group: "Resident Care" },
      { name: "Resident Progress Report", icon: FileText, route: "/nurse/progressreport", group: "Administration" },
      { name: "Appointment Calendar", icon: CalendarCheck, route: "/nurse/appointmentcalendar", group: "Coordination & Comms" },
      { name: "Pre-Admission Assessment", icon: ClipboardCheck, route: "/nurse/prescreen", group: "Administration" },
      ...
      { name: "Sbar Escalation", icon: Siren, route: "/nurse/escalations" },
      { name: "Orders & Prescriptions", icon: Pill, route: "/nurse/orders" },
      { name: "Approvals", icon: ClipboardCheck, route: "/nurse/approvalworkflows" },
      ...
      // Core SLMS Modules Aligned
      { name: "Medication Administration Record", icon: Pill, route: "/nurse/mar", group: "Medication" },
      { name: "Medication Compliance", icon: BarChart3, route: "/nurse/medcompliance", group: "Medication" },
      { name: "Medication Inventory", icon: Package, route: "/nurse/medinventory", group: "Medication" },
      { name: "Audit Log", icon: Shield, route: "/nurse/auditlog", group: "Administration" },
    ],
  },
  CAREGIVER: {
    ...
    sidebarLinks: [
      ...
      { name: "Task Assignment", icon: ClipboardList, route: "/caregiver/taskassignment", group: "Resident Care" },
      { name: "Care Logs", icon: ClipboardList, route: "/caregiver/carelogs", group: "Resident Care" },
      { name: "Care History", icon: History, route: "/caregiver/carehistory", group: "Resident Care" },
      { name: "ADL Monitoring", icon: Activity, route: "/caregiver/adlmonitoring", group: "Resident Care" },
      { name: "Weight Monitoring", icon: Scale, route: "/caregiver/weightmonitoring", group: "Resident Care" },
      { name: "Vitals Trend", icon: Activity, route: "/caregiver/vitalstrend", group: "Resident Care" },
      { name: "Shift Summary", icon: ClipboardCheck, route: "/caregiver/shiftsummary", group: "Resident Care" },
      { name: "Shift Endorsements", icon: FileText, route: "/caregiver/shiftendorsements", group: "Coordination & Comms" },
      { name: "Care Team", icon: Stethoscope, route: "/caregiver/careteam" },
      { name: "Call Bells", icon: BellRing, route: "/caregiver/callbells" },
      { name: "Sbar Escalation", icon: Siren, route: "/caregiver/escalations" },
  ...
  CARE_MANAGER: {
    ...
    sidebarLinks: [
      ...
      { name: "Care Logs", icon: ClipboardList, route: "/care_manager/carelogs", group: "Resident Care" },
      { name: "Care History", icon: History, route: "/care_manager/carehistory", group: "Resident Care" },
      { name: "Clinical Records", icon: FolderOpen, route: "/care_manager/clinicalrecords", group: "Resident Care" },
      { name: "Task Assignment", icon: ClipboardList, route: "/care_manager/taskassignment", group: "Administration" },
      { name: "ADL Monitoring", icon: Activity, route: "/care_manager/adlmonitoring", group: "Resident Care" },
      { name: "Weight Monitoring", icon: Scale, route: "/care_manager/weightmonitoring", group: "Resident Care" },
      { name: "Vitals Trend", icon: Activity, route: "/care_manager/vitalstrend", group: "Resident Care" },
      { name: "Shift Summary", icon: ClipboardCheck, route: "/care_manager/shiftsummary", group: "Resident Care" },
      { name: "Shift Endorsements", icon: FileText, route: "/care_manager/shiftendorsements", group: "Coordination & Comms" },
      { name: "Care Acuity & Level of Care", icon: Gauge, route: "/care_manager/careacuity", group: "Resident Care" },
      { name: "Wound Care", icon: Activity, route: "/care_manager/woundcare", group: "Resident Care" },
      { name: "Resident Progress Report", icon: FileText, route: "/care_manager/progressreport", group: "Administration" },
      { name: "Camera Monitoring", icon: Camera, route: "/care_manager/monitoring", group: "Clinical Monitoring" },
      { name: "Sbar Escalation", icon: Siren, route: "/care_manager/escalations", group: "Coordination & Comms" },
      { name: "Approvals", icon: ClipboardCheck, route: "/care_manager/approvalworkflows", group: "Medication" },
      ...
      { name: "Medication Compliance", icon: BarChart3, route: "/care_manager/medcompliance", group: "Medication" },
      { name: "Medication Inventory", icon: Package, route: "/care_manager/medinventory", group: "Medication" },
      { name: "Residents", icon: Users, route: "/care_manager/residents", group: "Resident Care" },
      { name: "Pre-Admission Assessment", icon: ClipboardCheck, route: "/care_manager/prescreen", group: "Administration" },
      { name: "Care Planning", icon: Target, route: "/care_manager/careplans", group: "Resident Care" },
      { name: "Referrals & Appointments", icon: CalendarCheck, route: "/care_manager/referrals", group: "Coordination & Comms" },
      { name: "Appointment Calendar", icon: CalendarCheck, route: "/care_manager/appointmentcalendar", group: "Coordination & Comms" },
  ...
  PHYSICIAN: {
    ...
    sidebarLinks: [
      ...
      { name: "Labs & Allergies", icon: Activity, route: "/physician/labs" },
      ...
      { name: "Sbar Escalation", icon: Siren, route: "/physician/escalations" },
