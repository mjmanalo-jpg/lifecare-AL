...
export const ROUTE_TO_TAB: Record<string, string> = {
  ...
  forms: "Sign & Upload",
  admissions: "Admission & Onboarding",
  registration: "Admission & Onboarding",
  ...
  careplangovernance: "Care Plan Generator",
  routinegenerator: "Routine Generator",
  movein: "Move-in",
...
export const ROLES: Record<Role, RoleDetails> = {
  ...
  SUPERADMIN: {
    ...
    sidebarLinks: [
      ...
      { name: "Admission & Onboarding", icon: UserPlus, route: "/superadmin/admissions", group: "Operations" },
  ...
  NURSE: {
    ...
    sidebarLinks: [
      ...
      { name: "Shift Endorsement", icon: Repeat, route: "/nurse/shiftclosehub", group: "Coordination & Close" },
    ],
  },
  CAREGIVER: {
    ...
    sidebarLinks: [
      ...
      // Daily Log / ADL / MAR open in-place from each resident card on the Shift
      // Dashboard (one tap, no page navigation). Weight is a standing sidebar item.
  ...
  RESIDENT_COORDINATOR: {
    ...
    sidebarGroupOrder: ["Today", "Residents", "Schedule", "Coordination", "Alerts", "Family Contacts", "Endorsement"],
    sidebarLinks: [
      ...
      { name: "Move-in", icon: Package, route: "/resident_coordinator/movein", group: "Residents" },
      { name: "Today & Schedule", icon: CalendarDays, route: "/resident_coordinator/schedule", group: "Schedule" },
      { name: "Admissions & Returns", icon: UserPlus, route: "/resident_coordinator/admissions", group: "Coordination" },
      { name: "Open Coordination", icon: Ticket, route: "/resident_coordinator/coordination", group: "Coordination" },
      { name: "Alerts for Action", icon: BellRing, route: "/resident_coordinator/alerts", group: "Alerts" },
      { name: "Family Update Preferences", icon: Mail, route: "/resident_coordinator/familycontacts", group: "Family Contacts" },
      { name: "Endorsement / Notes", icon: Repeat, route: "/resident_coordinator/endorsement", group: "Endorsement" },
    ],
  },
  FACILITY_ADMIN: {
    name: "Facility Admin",
    ...
    sidebarLinks: [
      ...
      { name: "Move-in", icon: Package, route: "/facility_admin/movein", group: "Residents" },
...
const LINK_GROUP_MAP: Record<string, SidebarGroup> = {
  ...
  "Admission & Onboarding": "Operations",
  "Rooms": "Operations",
...
export const groupSidebarLinks = (
  ...
  return [...new Set(orderedGroups)].filter((g) => buckets.has(g)).map((g) => ({
    group: g,
    links: buckets.get(g)!,
  }));
};
...
export const GLOBAL_FEATURES: Record<string, FeatureInfo> = {
  ...
  "Admission & Onboarding": { name: "Admission & Onboarding", icon: UserPlus, routeSegment: "admissions" },
