...
export const ROLES: Record<Role, RoleDetails> = {
  ...
  NURSE: {
    ...
    sidebarLinks: [
      ...
      { name: "One Care · One Journey", icon: Route, route: "/nurse/residentjourney", group: "Resident Care" },
      ...
      { name: "Care Delivery", icon: Activity, route: "/nurse/caredelivery", group: "Resident Care" },
      ...
      { name: "Additional Clinical Services", icon: Cross, route: "/nurse/additionalservices", group: "Resident Care" },
      { name: "Safeguarding", icon: ShieldCheck, route: "/nurse/safeguarding", group: "Clinical Monitoring" },
      { name: "Infection Control", icon: Activity, route: "/nurse/infectioncontrol", group: "Clinical Monitoring" },
      { name: "Clinical Protocols", icon: ScrollText, route: "/nurse/clinicalprotocols", group: "Clinical Monitoring" },
      { name: "Emergency & Evacuation", icon: Siren, route: "/nurse/emergencyprotocol", group: "Operations" },
      // Medication
  ...
  CARE_MANAGER: {
    ...
    sidebarLinks: [
      ...
      { name: "Care Delivery", icon: Activity, route: "/care_manager/caredelivery", group: "Resident Care" },
      ...
      { name: "Additional Clinical Services", icon: Cross, route: "/care_manager/additionalservices", group: "Resident Care" },
      { name: "Safeguarding", icon: ShieldCheck, route: "/care_manager/safeguarding", group: "Clinical Monitoring" },
      { name: "Infection Control", icon: Activity, route: "/care_manager/infectioncontrol", group: "Clinical Monitoring" },
      { name: "Clinical Protocols", icon: ScrollText, route: "/care_manager/clinicalprotocols", group: "Clinical Monitoring" },
      { name: "Emergency & Evacuation", icon: Siren, route: "/care_manager/emergencyprotocol", group: "Operations" },
      // Medication
