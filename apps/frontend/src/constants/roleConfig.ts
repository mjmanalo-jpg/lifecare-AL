...
export const ROUTE_TO_TAB: Record<string, string> = {
  ...
  careplans: "Care Plans & Directives",
  consults: "Consults & Referrals",
  escalations: "SBAR Escalations",
...
export const ROLES: Record<Role, RoleDetails> = {
  ...
  NURSE: {
    ...
    sidebarLinks: [
      ...
      { name: "Patient Rounds", icon: ClipboardList, route: "/nurse/rounds" },
      { name: "Medical Records", icon: ShieldCheck, route: "/nurse/records" },
      { name: "Orders & Prescriptions", icon: Pill, route: "/nurse/orders" },
      { name: "Medication Rounds", icon: Pill, route: "/nurse/medications" },
      { name: "Clinical Notes", icon: PenTool, route: "/nurse/notes" },
      { name: "Incident Review", icon: AlertTriangle, route: "/nurse/incidents" },
      { name: "SBAR Escalations", icon: Siren, route: "/nurse/escalations" },
  ...
  CAREGIVER: {
    ...
    sidebarLinks: [
      ...
      { name: "SBAR Escalations", icon: Siren, route: "/caregiver/escalations" },
  ...
  FACILITY_ADMIN: {
    ...
    sidebarLinks: [
      ...
      { name: "SBAR Escalations", icon: Siren, route: "/facility_admin/escalations" },
  ...
  PHYSICIAN: {
    ...
    sidebarLinks: [
      { name: "Command Center", icon: Grid, route: "/physician/dashboard" },
      { name: "Case Review", icon: ClipboardList, route: "/physician/casereview" },
      { name: "Prescribing & Orders", icon: Pill, route: "/physician/orders" },
      { name: "Care Plans & Directives", icon: Target, route: "/physician/careplans" },
      ...
      { name: "SBAR Escalations", icon: Siren, route: "/physician/escalations" },
...
export const GLOBAL_FEATURES: Record<string, FeatureInfo> = {
  ...
  "SBAR Escalations": { name: "SBAR Escalations", icon: Siren, routeSegment: "escalations" },
  ...
  "Facility Maintenance": { name: "Facility Maintenance", icon: Wrench, routeSegment: "maintenance" },
