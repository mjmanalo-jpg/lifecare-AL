...
export const ROUTE_TO_TAB: Record<string, string> = {
  ...
  assessmentv42: "Resident Assessment (v4.2)",
...
export const ROLES: Record<Role, RoleDetails> = {
  ...
  NURSE: {
    ...
    sidebarLinks: [
      ...
      { name: "Resident Assessment (v4.2)", icon: ClipboardList, route: "/nurse/assessmentv42", group: "Resident Care" },
  ...
  CARE_MANAGER: {
    ...
    sidebarLinks: [
      ...
      { name: "Resident Assessment (v4.2)", icon: ClipboardList, route: "/care_manager/assessmentv42", group: "Resident Care" },
