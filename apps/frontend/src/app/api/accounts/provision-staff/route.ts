...
const STAFF_ROLES: Role[] = ["CARE_MANAGER", "CRM", "RESIDENT_COORDINATOR", "NURSE", "CAREGIVER", "PHYSICIAN", "FACILITY_ADMIN", "BILLING_ADMIN", "NUTRITIONIST", "KITCHEN", "HOUSEKEEPING", "MAINTENANCE", "SECURITY", "FLEET_MANAGEMENT", "DRIVER", "SUPERADMIN"] as Role[];
const roleLabel = (r: Role) => ({ CARE_MANAGER: "Care Manager", CRM: "CRM Specialist", RESIDENT_COORDINATOR: "Resident Coordinator", NURSE: "Nurse", CAREGIVER: "Caregiver", PHYSICIAN: "Physician", FACILITY_ADMIN: "Facility Admin", BILLING_ADMIN: "Billing Admin", NUTRITIONIST: "Nutritionist", KITCHEN: "Kitchen", HOUSEKEEPING: "Housekeeping", MAINTENANCE: "Maintenance", SECURITY: "Security", FLEET_MANAGEMENT: "Fleet Manager", DRIVER: "Driver", SUPERADMIN: "Super Admin" } as Record<string, string>)[r] ?? "Staff";
